...
import com.rlsp.springboot.fundamentals.util.AnimeCreator;

@ExtendWith(SpringExtension.class) // user Spring and don't need the context (DB)
class AnimeControllerTest {

	@InjectMocks // usado para testar a propro=ia classe
    private AnimeController animeController;
	
    @Mock // da suporte ao test da propria classe
    ...
    public void findByName_ReturnListOfAnimesInsidePageObject_WhenSuccessful() {
        ...
        List<Anime> animeList = animeController.findAnimeBydId("DBZ").getBody();
    ...
    public void delete_RemovesAnime_WhenSuccessful() {
        ...
        ResponseEntity<Anime> responseEntity = animeController.deleteAnimeBydId(1);
